    ...
    public class EnvironmentGradientBaker : MonoBehaviour
    {
        ...
        public static TextureFormat ConvertFormat(RenderTextureFormat inputFormat)
        {
            ...
            switch (inputFormat)
            {
                ...
                default:
                    var format_string = System.Enum.GetName(typeof(RenderTextureFormat), inputFormat);
                    var format_int = (int)System.Enum.Parse(typeof(TextureFormat), format_string);
                    outputFormat = (TextureFormat)format_int;
                    break;
            }
