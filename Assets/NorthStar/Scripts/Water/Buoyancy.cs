...
namespace NorthStar
{
    ...
    public class Buoyancy : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("How many nodes on either side of an axis. Each node is used to tell where on the object is underwater."), FormerlySerializedAs("SCANEXTENT")]
